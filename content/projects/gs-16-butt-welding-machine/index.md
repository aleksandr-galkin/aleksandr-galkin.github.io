...
![Typical manual welding machine](typical-manual-machine.png)

![Thermal welding process](thermal-welding-process.png)
...
![Sketches and the process of finding a solution](sketches-process.png)
...
![Main parts of the machine](main-parts.png)
...
![Main parts of locking & loading mechanism](locking-loading-main-parts.png)
...
![Innovative brake parts](innovative-brake-parts.png)
...
![User step 1](user-step-1.png)
 
![User step 2](user-step-2.png)

![User step 3](user-step-3.png)
...
![Load application process](load-application.png)
